...
for idx in tqdm(range(32)):#velocities.shape[0])):
    traces_div_2, traces_div_4, traces_div_8, traces, nt, dt, c, nx, dx = get_traces(idx, nx)
    y.append(trace_fd.clone())
